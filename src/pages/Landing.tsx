      ...
      <header className="sticky top-0 z-50 border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-8">
          <div className="flex items-center gap-2.5">
            <div className="h-9 w-9 rounded-[4px] bg-primary flex items-center justify-center">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 py-20 md:py-32 relative">
          ...
          <div className="mt-16 md:mt-20 max-w-5xl mx-auto">
            <div className="rounded-[4px] border bg-card shadow-2xl shadow-primary/5 overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 border-b bg-muted/30">
                ...
                <div className="flex-1 flex justify-center">
                  <div className="bg-muted rounded-[4px] px-4 py-1 text-xs text-muted-foreground">
                    app.sinistreflow.fr
                  </div>
                </div>
              </div>
              <div className="p-6 md:p-8 bg-gradient-to-br from-background to-muted/30">
                <div className="grid grid-cols-4 gap-4 mb-6">
                  {[
                    ...
                    <div key={stat.label} className="rounded-[4px] border bg-card p-4">
                ...
                <div className="space-y-2">
                  {["Fuite d'eau — 12 rue Victor Hugo", "Chaudière en panne — 8 av. Gambetta", "Volet roulant bloqué — 3 pl. de la Mairie"].map((item, i) => (
                    <div key={i} className="flex items-center justify-between rounded-[4px] border bg-card px-4 py-3">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
            {[
              ...
              <div key={stat.label} className="rounded-[4px] border bg-card p-6 text-center hover:shadow-[0_20px_60px_-10px_hsl(180_5%_11%/0.06)] transition-shadow">
                <div className="h-10 w-10 rounded-[4px] bg-destructive/10 flex items-center justify-center mx-auto mb-3">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
            {[
              ...
              <div key={item.title} className="rounded-[4px] border bg-card p-6 hover:shadow-[0_20px_60px_-10px_hsl(180_5%_11%/0.06)] transition-shadow">
                <div className="h-10 w-10 rounded-[4px] bg-destructive/10 flex items-center justify-center mb-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="rounded-[4px] border-2 border-dashed border-destructive/20 bg-destructive/5 p-6 text-center">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={item.title} className="rounded-[4px] border bg-card p-6 hover:shadow-[0_20px_60px_-10px_hsl(180_5%_11%/0.06)] transition-shadow">
                <div className="h-10 w-10 rounded-[4px] bg-primary/10 flex items-center justify-center mb-4">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={item.title} className="flex gap-4 p-5 rounded-[4px] border bg-card hover:shadow-[0_20px_60px_-10px_hsl(180_5%_11%/0.06)] transition-shadow">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 max-w-4xl mx-auto">
            {[
              ...
              <div key={item.label} className="flex flex-col items-center gap-3 rounded-[4px] border bg-card p-6 hover:shadow-[0_20px_60px_-10px_hsl(180_5%_11%/0.06)] transition-shadow">
      ...
      <footer className="border-t py-10">
        <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="h-7 w-7 rounded-[4px] bg-primary flex items-center justify-center">
